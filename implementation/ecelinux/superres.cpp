...
void dut(hls::stream<pixel_type> &strm_in, hls::stream<pixel_type> &strm_out){
  ...
  #pragma HLS stream variable=superres_in0 depth=400 // should be 4 * ORIG_DIM?
  #pragma HLS stream variable=superres_out0 depth=400
  #pragma HLS stream variable=superres_in1 depth=400
  #pragma HLS stream variable=superres_out1 depth=400
  #pragma HLS stream variable=superres_in2 depth=400
  #pragma HLS stream variable=superres_out2 depth=400
