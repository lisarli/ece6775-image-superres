...
void dut(hls::stream<pixel_type> &strm_in, hls::stream<pixel_type> &strm_out){
  ...
  #pragma HLS stream variable=superres_in0 depth=1200
  #pragma HLS stream variable=superres_out0 depth=1200
  #pragma HLS stream variable=superres_in1 depth=1200
  #pragma HLS stream variable=superres_out1 depth=1200
  #pragma HLS stream variable=superres_in2 depth=1200
  #pragma HLS stream variable=superres_out2 depth=1200
...
void superres_xcel(hls::stream<pixel_type> &input_image, hls::stream<pixel_type> &output_image){
  ...
  #pragma HLS stream variable=upsample_out depth=1200
  #pragma HLS stream variable=layer0_out depth=1200
  #pragma HLS stream variable=layer1_out depth=1200
